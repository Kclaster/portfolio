...
class Sidebar extends React.Component {
    ...
    return (
        <div style={{'transform': `translateX(${slide})`}} className={`sidebar-container ${!this.props.displaySidebar.showSidebar ? null : null}`}>
            <div onClick={this.handleClick} className="new-arrow"></div>
            <div className="sidebar">
                <img className="profile-pic" src={profilePic} alt="my profile"/>
                <a rel="noopener noreferrer" target="_blank" href={resume}><h3>My Resume</h3></a>
                <a rel="noopener noreferrer" target="_blank" href="https://www.linkedin.com/in/kyle-laster/"><h3>LinkedIn</h3></a>
                <a rel="noopener noreferrer" target="_blank" href="https://github.com/Kclaster"><h3>GitHub</h3></a>
                <div className="email">
